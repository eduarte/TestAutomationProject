...
public class VacationManagementTest extends BaseTest {
	...
	public void testCreatingANewUser() {
		...
		result = signInPage.login(userEmailText, passwordText).goToCreateNewEmployee()
				.createNewEmployee(employeeName, employeeEmail, employeeID, leaderName, startDay)
				.verifyEmployeeInformation(expectedCreatedText, employeeName, employeeEmail, employeeID, leaderName,
						startDay);
	...
	public void testVerifyPublicInfo() {
		...
		employeeInfo = signInPage.goToPublicSitePage().findEmployee(employeeID).getEmployeeInfo();
	...
	public void testDeleteUser() {
		...
		signInPage.login(userEmailText, passwordText).deleteEmployee(employeeName, leaderName).acceptDeleteAlert();
