...
public class NewEmployeePage extends BasePage {
	...
	public NewEmployeePage createNewEmployee(String employeeName, String employeeEmail, String employeeID,
			String leaderName, String startDay) {
		String[] name = employeeName.split(" ");
		setEmployeeName(name[0]).setEmployeeLastName(name[1]).setEmployeeEmail(employeeEmail).setEmployeeID(employeeID)
				.setLeaderName(leaderName).setStartDate(startDay).clickCreateNewEmployee();
	...
	public Boolean verifyEmployeeInformation(String successMessage, String employeeName, String employeeEmail,
			String employeeID, String leaderName, String startDay) {
		Boolean result = true;
		String[] name = employeeName.split(" ");
		startDay = startDay.replace("-", "/");
		String[] employeeInfo = { successMessage, name[0], name[1], employeeEmail, employeeID, leaderName, startDay };
